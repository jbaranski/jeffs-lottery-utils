...
sync-plugins:
	...
	@TMPDIR=$$(mktemp -d) && \
	  ...
	  for plugin in jeff-plugin-angular jeff-plugin-aws-solution-architect jeff-plugin-golang jeff-plugin-project jeff-plugin-python jeff-plugin-tailwind jeff-plugin-typescript; do \
